      ...
      <div class="row">
        <div class="col-md-3">
          <div class="left-content-area">
            ...
            <ul class="left-list-wrap ps-5 ">
              <li class="">Business Information</li>
              <li class="">Personal Information</li>
              <li class="">Business Bank Information</li>
              <li class="">Processing Information</li>
            </ul>
          ...
          <form action="">
            <div class="main-form-wrap">
              <div class="tab1 step-form active" id="step1">
                ...
                <div class="downArrow bounce"><img width="30" height="30" alt="" src="./assets/images/arrow-bottom.webp"></div>
              </div>
                ...
                <div class="row align-items-center">
                  <div class="col-md-12">
                    <div class="backbtn">
                      ...
                      <span class="fs-14 ms-3 text-light-blue">Back to business information</span>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="backbtn">
                      ...
                      <span class="fs-14 ms-3 text-light-blue">Back to personal information</span>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="backbtn">
                      ...
                      <span class="fs-14 ms-3 text-light-blue">Back to bank information</span>
                    </div>
...
$(document).ready(function () {
  ...
  function showStep(step) {
    // Prevent currentStep from exceeding totalSteps
    ...
    // Update progress bar
    var progressPercentage = initialProgress + (currentStep - 1) * (100 - initialProgress) / (totalSteps - 1);
    $('.progress-bar').css('width', progressPercentage + '%');

    // Update step count
    $('.count span:last-child').text(currentStep + '/' + totalSteps);
...
$('button[id^=next]').click(function () {
    ...
    if (currentStep < totalSteps) {
      var input = $('#step' + currentStep + ' input'); // Assuming input field is within the current step
      if (input.val() === '') {
          // Check if the element has already been appended
          if (!isCheckAppended) {
              // alert('Please enter a value');
              var fieldWrap = $('#step' + currentStep + ' .field-wrap');
              fieldWrap.append('<span class="valid-check">Lorem, ipsum.</span>');
              isCheckAppended = true; // Set the flag to true after appending
          }
